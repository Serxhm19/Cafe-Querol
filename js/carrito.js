    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var qrCodeBaseUri = 'https://api.qrserver.com/v1/create-qr-code/?',
                params = {
                    data: 'https://sergihernandez.bernat2024.es/?controller=usuario&action=visualizarPedido&ID_PEDIDO=' + response.ID_PEDIDO, // Actualización de la URL
                    size: '150x150',
                    margin: 1,
                    download: 1
                };
            ...
            setTimeout(function () {
                window.location.href = 'https://sergihernandez.bernat2024.es/?controller=usuario&action=mispedidos';
            }, 200); 
