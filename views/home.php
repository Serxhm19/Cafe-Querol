            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img class="testimonial-img"
                        src="img\IMGHome\conjunto-fresco-hermoso-taza-cafe-manana-relajacion.jpg" alt="Banner2">
                </div>
            </div>
            <!-- Carousel Buttons -->
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-12 col-lg-4">
                <div class="category">
                    <img src="img/products/Frappe.png" alt="Frappe" class="img-fluid">
                    <a href="?controller=producto&action=bebidas" class="btn btn-light mt-2">BEBIDAS</a>
                </div>
            </div>
            <div class="col-md-4 col-lg-4">
                <div class="category">
                    <img src="img/products/Donut.png" alt="donut" class="img-fluid">
        ...
        <div class="container mt-4">
            ...
            <div class="productos-container">
                <div class="row imagenestopVentas">
                    <?php
                    $productos = productoDAO::topVentas();
        ...
        <div class="row">
            <div class="logoQuerol d-md-flex flex-md-row">
                <div class="col-12 col-md-3 col-sm-6">
                    <picture>
                        <!-- Imagen para pantallas más grandes (ancho mínimo de 576px) -->
                        <source media="(min-width: 576px)" sizes="(min-width: 576px) 270px, 100vw"
                            srcset="img/IMGHome/logoquerol.webp">

                        <!-- Imagen por defecto para pantallas más pequeñas -->
                        <img sizes="(max-width: 575px) 100vw, (min-width: 576px) 270px" src="img\icons\logoQuerol.jpg"
                            alt="logo" class="img-fluid mx-auto">
                    </picture>
