        ...
        <div class="row">
            <div class="categoriesdropdown col-2">
                ...
                <ul class="dropdown-menu">
                    <li><button class="dropdown-item" type="button">Bebidas</button></li>
                    <li><button class="dropdown-item" type="button">Alimentación</button></li>
                    <li><button class="dropdown-item" type="button">Packs</button></li>
                </ul>
            </div>
