...
<body>
    ...
    <body>
        <?php $ultimoIdPedido = productoController::mostrarUltimoPedido(); ?>
        <div class="container">
            <h2>Detalles del Pedido</h2>
            <p>ID Pedido:
                <?php echo $ultimoIdPedido; ?>
            </p>
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                    // Llamar a la función para obtener los detalles del último pedido
                    $ultimoPedidoInfo = productoController::mostrarUltimoPedido();
                    $detallesPedido = productoController::obtenerDetallesDelPedido2($ultimoPedidoInfo);
