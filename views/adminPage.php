...
<body>
  ...
  <section class="title">
    <h1 class="title">Pagina Administrador</h1>
  </section>
    ...
    <table class="table table-striped table-hover">
      ...
      <tbody>
        ...
        foreach ($productos as $producto) {
          ...
          echo '<td>
                        <a href="?controller=producto&action=eliminarProducto&id=' . $producto->ID_PRODUCTO . '" class="btn btn-danger">Eliminar</a>
                        <a href="?controller=producto&action=modificarProducto&id=' . $producto->ID_PRODUCTO . '" class="btn btn-warning">Modificar</a>
                    </td>';
          echo '</tr>';
        }
        ?>
